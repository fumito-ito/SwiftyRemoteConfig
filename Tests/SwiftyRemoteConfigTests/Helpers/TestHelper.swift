...
struct FrogFirebaseConfig {
    static var firebaseOptions: FirebaseOptions {
        let options = FirebaseOptions(googleAppID: "1:528030662976:ios:f9691ae052efde771dbaa5",
                                      gcmSenderID: "528030662976")
        options.apiKey = "AIzaSyDoeTH6r43Y9vZ0Y98IzpxAn2dV2YBAcKg"
        options.projectID = "swiftyremoteconfigexample"
        
        options.bundleID = "com.github.fumito-ito.SwiftyRemoteConfigExample"
        options.clientID = "528030662976-0q2liuia5e4lthon3rpp84tgrn70pios.apps.googleusercontent.com"
        options.databaseURL = "https://swiftyremoteconfigexample.firebaseio.com"
        options.storageBucket = "swiftyremoteconfigexample.appspot.com"
