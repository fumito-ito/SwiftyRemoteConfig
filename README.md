...
```
github "fumito-ito/SwiftyRemoteConfig" ~> 0.0.5
```
...
let package = Package(
    ...
    products: [...],
    dependencies: [
        .package(url: "https://github.com/fumito-ito/SwiftyRemoteConfig.git", .upToNextMajor(from: "0.0.5"))
    ]
)
```
